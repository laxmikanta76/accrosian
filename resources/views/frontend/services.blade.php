    ...
    <div class="container">
        ...
        <div class="services-grid">
            ...
            <div class="service-card reveal reveal-delay-{{ ($i%3)+1 }}">
                ...
                @else
                    <img src="{{ asset('assets/images/web-dev-img.png') }}" alt="{{ $service->title }}" class="service-card-img" />
                @endif
                <div class="service-card-overlay"></div>
                <div class="service-card-content">
                    <h3 class="service-title">{{ $service->icon }} {{ $service->title }}</h3>
                    <p style="color:rgba(255,255,255,0.8);font-size:0.9rem;margin-bottom:16px;line-height:1.6">{{ Str::limit($service->short_description, 100) }}</p>
