    ...
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="<?php echo e(route('admin.services.index')); ?>"
                class="sidebar-link <?php echo e(request()->routeIs('admin.services*') ? 'active' : ''); ?>">
                <i class="fas fa-cogs"></i> Services
            </a>
            <a href="<?php echo e(route('admin.portfolio.index')); ?>"
                class="sidebar-link <?php echo e(request()->routeIs('admin.portfolio*') ? 'active' : ''); ?>">
                <i class="fas fa-briefcase"></i> Portfolio
            </a>
            <a href="<?php echo e(route('admin.blog.index')); ?>"
                class="sidebar-link <?php echo e(request()->routeIs('admin.blog*') ? 'active' : ''); ?>">
                <i class="fas fa-blog"></i> Blog Posts
            </a>
            <a href="<?php echo e(route('admin.pages.index')); ?>"
                class="sidebar-link <?php echo e(request()->routeIs('admin.pages*') ? 'active' : ''); ?>">
                <i class="fas fa-file-alt"></i> Pages
            </a>

            <div class="sidebar-section">Enquiries</div>
            <a href="<?php echo e(route('admin.contact.index')); ?>"
                class="sidebar-link <?php echo e(request()->routeIs('admin.contact*') ? 'active' : ''); ?>">
...
</html><?php /**PATH C:\xamppNew\htdocs\accroNew\resources\views/layouts/admin.blade.php ENDPATH**/ ?>