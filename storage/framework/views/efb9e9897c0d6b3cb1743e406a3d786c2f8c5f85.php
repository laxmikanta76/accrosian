...
<?php $__env->startSection('meta_description', $page->meta_description ?? 'Learn about Accrosian, our mission, values, and the talented team behind our innovative software solutions.'); ?>
        ...
        <div class="about-grid">
            <div class="about-image-wrap reveal">
                <div class="about-image-main">
                    <img src="<?php echo e(asset('assets/images/about-us-img.png')); ?>" alt="About Accrosian" class="page-hero-image" />
...
<section style="padding:80px 0;background:var(--surface)">
    <div class="container">
        <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(180px,1fr));gap:40px;text-align:center">
            <?php $__currentLoopData = [['250+','Projects Delivered'],['98%','Client Satisfaction'],['8+','Years Experience'],['50+','Team Members']]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="reveal">
                <div style="font-family:var(--font-display);font-size:2.5rem;font-weight:800;color:var(--orange)"><?php echo e($stat[0]); ?></div>
