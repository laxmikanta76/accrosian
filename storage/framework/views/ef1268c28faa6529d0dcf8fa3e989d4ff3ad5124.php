    ...
    <table class="admin-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <div style="font-weight:600;color:var(--text)"><?php echo e($service->title); ?></div>
                    <div style="font-size:0.8rem;color:var(--muted);margin-top:2px">
                        <?php echo e(Str::limit($service->short_description, 50)); ?>
                ...
                <td>
                    <span class="badge badge-<?php echo e($service->status ? 'active' : 'inactive'); ?>">
            ...
            <tr>
                <td colspan="7" style="text-align:center;padding:40px;color:var(--text-light)">
                    No services found.
                    <a href="<?php echo e(route('admin.services.create')); ?>" style="color:var(--orange)">Add one</a>
                </td>
            </tr>
            <?php endif; ?>
        </tbody>
