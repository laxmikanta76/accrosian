...
<body>
    ...
    <div class="loader" id="loader">
        <?php if(isset($setting) && $setting->logo): ?>
            <img src="<?php echo e(asset('storage/' . $setting->logo)); ?>" alt="<?php echo e($setting->site_name ?? 'Logo'); ?>" style="height:64px;border-radius:12px">
        <?php else: ?>
            <img src="<?php echo e(asset('assets/images/logo2.png')); ?>" alt="Accrosian" style="height:64px;border-radius:12px">
        <?php endif; ?>
...
<?php /**PATH C:\xamppNew\htdocs\accroNew\resources\views/layouts/app.blade.php ENDPATH**/ ?>