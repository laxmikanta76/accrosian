            ...
            <li class="nav-dropdown nav-mega-parent">
                ...
                <div class="dropdown-menu dropdown-mega">
                    ...
                    <div class="mega-groups-wrap">
                        <?php $__currentLoopData = $grouped; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category => $services): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="mega-group">
                            <div class="mega-group-title"><?php echo e($category); ?></div>
                            ...
                            <a href="<?php echo e(route('services.show', $svc->slug)); ?>" class="mega-group-item">
                                <span class="mega-item-icon"><?php echo e($svc->icon); ?></span>
                                <span><?php echo e($svc->title); ?></span>
                            </a>
