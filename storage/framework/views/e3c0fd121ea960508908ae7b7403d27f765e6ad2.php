<nav class="navbar" id="navbar">
    <div class="nav-inner">
        ...
        <ul class="nav-menu">
            ...
            <li><a href="<?php echo e(route('portfolio')); ?>" class="<?php echo e(request()->routeIs('portfolio') ? 'active' : ''); ?>">Portfolio</a></li>
        ...
        <div style="display:flex;align-items:center;gap:8px;margin-left:8px;">
            ...
            <form action="<?php echo e(route('logout')); ?>" method="POST" style="margin:0;">
                <?php echo csrf_field(); ?>
                <button type="submit" class="btn btn-sm" style="background:transparent;border:1px solid rgba(255,255,255,0.3);color:#fff;cursor:pointer;">Logout</button>
            </form>
        </div>
        <?php endif; ?>
...
<?php /**PATH C:\xamppNew\htdocs\accroNew\resources\views/partials/navbar.blade.php ENDPATH**/ ?>