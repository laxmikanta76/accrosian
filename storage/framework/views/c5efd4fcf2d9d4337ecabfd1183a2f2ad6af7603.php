        ...
        <div class="admin-card">
            ...
            <div class="form-row">
                <div class="form-field">
                    <label>Title *</label>
                    <input type="text" name="title" value="<?php echo e(old('title', $portfolio->title ?? '')); ?>" required />
                </div>
                <div class="form-field">
                    <label>Slug</label>
                    <input type="text" name="slug" value="<?php echo e(old('slug', $portfolio->slug ?? '')); ?>"
            ...
            <div class="form-row">
                <div class="form-field">
                    ...
                    <input type="text" name="category" value="<?php echo e(old('category', $portfolio->category ?? '')); ?>"
                        placeholder="e.g. Web Development" />
                </div>
                <div class="form-field">
                    <label>Sort Order</label>
                    <input type="number" name="sort_order"
                        value="<?php echo e(old('sort_order', $portfolio->sort_order ?? 0)); ?>" />
                </div>
            </div>
            <div class="form-field">
                <label>Description</label>
                <textarea name="description" rows="5"><?php echo e(old('description', $portfolio->description ?? '')); ?></textarea>
            </div>
        </div>
        <div class="admin-card">
            ...
            <div class="form-field"><label>Meta Title</label><input type="text" name="meta_title"
                    value="<?php echo e(old('meta_title', $portfolio->meta_title ?? '')); ?>" /></div>
            <div class="form-field"><label>Meta Description</label><textarea name="meta_description"
                    rows="3"><?php echo e(old('meta_description', $portfolio->meta_description ?? '')); ?></textarea></div>
            <div class="form-field"><label>Meta Keywords</label><input type="text" name="meta_keywords"
                    value="<?php echo e(old('meta_keywords', $portfolio->meta_keywords ?? '')); ?>" /></div>
        </div>
    </div>
    <div>
        <div class="admin-card">
            ...
            <div class="toggle-wrap" style="margin-bottom:16px">
                <label class="toggle"><input type="checkbox" name="status" value="1"
                        <?php echo e(old('status', $portfolio->status ?? true) ? 'checked' : ''); ?>><span
            ...
            <div style="display:flex;gap:8px">
                ...
                <a href="<?php echo e(route('admin.portfolio.index')); ?>" class="btn-admin btn-admin-outline">Cancel</a>
            </div>
        </div>
        <div class="admin-card">
            <h3 class="admin-card-title" style="margin-bottom:16px">Image</h3>
            <?php if(isset($portfolio) && $portfolio && $portfolio->image): ?>
...
</div><?php /**PATH C:\xamppNew\htdocs\accroNew\resources\views/admin/portfolio/_form.blade.php ENDPATH**/ ?>