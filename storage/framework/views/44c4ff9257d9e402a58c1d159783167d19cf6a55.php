...
<?php $__env->startSection('meta_description', 'AIRS by Accrosian transforms students into industry-ready problem solvers through
    ...
    <div class="container airs-hero-inner">
        <div class="airs-hero-content">
            ...
            <div class="airs-hero-actions">
                <a href="<?php echo e(route('student.register')); ?>" class="btn btn-primary airs-btn-primary">
                    <span>🚀</span> Join AIRS
                </a>
            ...
            <div class="airs-hero-stats">
                ...
                <div class="airs-stat">
                    <div class="airs-stat-num"><?php echo e($num); ?></div>
                    <div class="airs-stat-label"><?php echo e($label); ?></div>
                </div>
        ...
        <div class="airs-what-grid">
            <div class="reveal">
                ...
                <div style="margin-top:36px">
                    <a href="<?php echo e(route('student.register')); ?>" class="btn btn-primary">
                        Join AIRS Now →
                    </a>
                </div>
            </div>
    ...
    <div class="container">
        ...
        <div class="airs-gap-grid">
            ...
            <div class="airs-gap-card reveal">
                <div class="airs-gap-icon"><?php echo e($icon); ?></div>
                <h4 class="airs-gap-title"><?php echo e($title); ?></h4>
                <p class="airs-gap-desc"><?php echo e($desc); ?></p>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    </div>
...
<section class="airs-section" style="background:var(--navy-mid)">
    <div class="container">
        ...
        <div class="airs-why-grid">
            ...
            ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$icon, $title, $color, $desc, $points]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="airs-why-card reveal" style="--card-accent:<?php echo e($color); ?>">
                <div class="airs-why-header" style="background:<?php echo e($color); ?>">
                    <span style="font-size:1.3rem"><?php echo e($icon); ?></span>
                    <h4 class="airs-why-title"><?php echo e($title); ?></h4>
                </div>
                <div class="airs-why-body">
                    ...
                    <ul class="airs-why-list">
                        ...
                        <li><span style="color:<?php echo e($color); ?>">✓</span> <?php echo e($point); ?></li>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </ul>
                </div>
            </div>
...
<section class="airs-section" style="background:var(--navy-mid)">
    <div class="container">
        ...
        <div class="airs-how-grid">
            ...
            ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => [$icon, $title, $desc]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="airs-how-card reveal reveal-delay-<?php echo e(($i % 3) + 1); ?>">
                <div class="airs-how-icon"><?php echo e($icon); ?></div>
                <h4 class="airs-how-title"><?php echo e($title); ?></h4>
                <p class="airs-how-desc"><?php echo e($desc); ?></p>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    </div>
        ...
        <div class="reveal">
            ...
            <div class="airs-fellowship-perks">
                ...
                <div class="airs-perk-card">
                    <div class="airs-perk-icon"><?php echo e($icon); ?></div>
                    <div class="airs-perk-title"><?php echo e($title); ?></div>
                    <div class="airs-perk-desc"><?php echo e($desc); ?></div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
...
<section class="cta-section">
    <div class="container cta-inner">
        ...
        <div class="cta-actions">
            ...
            <a href="<?php echo e(route('contact')); ?>" class="btn btn-outline">
                Contact Us
            </a>
        </div>
    </div>
