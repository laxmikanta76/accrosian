...
<section style="padding:100px 0">
    <div class="container">
        <div style="text-align:center;margin-bottom:60px" class="reveal">
            ...
            <p class="section-subtitle" style="margin:0 auto">From concept to deployment, we cover the entire technology spectrum for your business.</p>
        </div>
        ...
        <div class="services-grid">
            ...
            <div class="service-card reveal reveal-delay-<?php echo e(($i%3)+1); ?>">
                <?php if($service->image && !str_starts_with($service->image,'assets/')): ?>
                    <img src="<?php echo e(asset('storage/'.$service->image)); ?>" alt="<?php echo e($service->title); ?>" class="service-card-img" />
                <?php elseif($service->image): ?>
                    <img src="<?php echo e(asset($service->image)); ?>" alt="<?php echo e($service->title); ?>" class="service-card-img" />
                <?php else: ?>
                    <img src="<?php echo e(asset('assets/images/web-dev-img.png')); ?>" alt="<?php echo e($service->title); ?>" class="service-card-img" />
                <?php endif; ?>
                <div class="service-card-overlay"></div>
                <div class="service-card-content">
                    <h3 class="service-title"><?php echo e($service->icon); ?> <?php echo e($service->title); ?></h3>
                    <p style="color:rgba(255,255,255,0.8);font-size:0.9rem;margin-bottom:16px;line-height:1.6"><?php echo e(Str::limit($service->short_description, 100)); ?></p>
...
<section class="features-section">
    <div class="container">
        ...
        <div class="features-grid">
            <?php $__currentLoopData = [['⚡','Fast Delivery','Agile processes ensure rapid delivery without sacrificing quality.'],['🔒','Enterprise Security','Bank-grade security practices baked into every layer.'],['📈','Scalable Architecture','Systems designed to grow from startup to enterprise.'],['🤝','Dedicated Support','24/7 support teams ensuring your systems run flawlessly.']]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
