...
track?.addEventListener('mouseleave', () => { autoSlide = setInterval(() => goToSlide(currentSlide + 1), 5000); });
...
document.querySelectorAll('.btn').forEach(btn => {
  btn.addEventListener('click', function(e) {
    ...
    style.textContent = '@keyframes rippleAnim{from{transform:scale(0);opacity:1}to{transform:scale(4);opacity:0}}';
...
console.log('%c✨ Accrosian - Turning Ideas Into Reality', 'color:#E8750A;font-size:16px;font-weight:bold;');
